            ...
            <div ref={handImages ? undefined : useRef<HTMLDivElement>(null)} className="bg-[#050510] p-8 rounded-3xl space-y-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="mystic-card p-6 md:p-10 rounded-[3rem] aspect-square relative overflow-hidden group"
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                        <div className="relative z-10 flex flex-col h-full">
                            {/* Header apilable en móviles */}
                            ...
                            <div className="flex-1 min-h-[220px]">
                                <ResponsiveContainer width="100%" height="100%">
                                    {/* Reducimos el outerRadius de 80% a 60% para dar aire a las letras */}
                                    <RadarChart cx="50%" cy="50%" outerRadius="60%" data={radarData}>
                                        <PolarGrid stroke="rgba(255,255,255,0.05)" />
                                        <PolarAngleAxis dataKey="subject" tick={{ fill: '#888', fontSize: 11, fontWeight: 700 }} />
